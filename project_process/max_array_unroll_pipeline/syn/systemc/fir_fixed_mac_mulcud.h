...
// ==============================================================
#ifndef __fir_fixed_mac_mulcud__HH__
#define __fir_fixed_mac_mulcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_fixed_mac_mulcud) {
    ...
    SC_CTOR(fir_fixed_mac_mulcud):  simcore_mac_0_U ("simcore_mac_0_U") {
